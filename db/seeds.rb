...
users2 = User.new(email: "yungthugga022@gmail.com", password:"12345678", password_confirmation:"12345678",username:"@Youngthug" ,
...
chatrooms5 = Chatroom.create
   ...
   description: "New Mussiiccc droping sooon, here's a sample...",
   category: "rap",
   user:users2)

   posts3 = Post.create(title: "whats on your mind moosician",
   description: "Leave me alone, what do you guys think?",
   category: "rap",
   user:users3)
   ...
   description: "Need new talent, DM me...",
   category: "jazz",
   user:users5)
